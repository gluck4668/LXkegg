...
# To judge whether a package was installed. If not, it will be installed.
  pack <- data.frame(c("devtools","BiocManager","ggnewscale","tidyverse", "R.utils",
                       ...
                       "ggrepel","RColorBrewer", "ggthemes","rticles","grid","patchwork","conflicted") )
...
#---------------------------------------
  ...
  include_pathways <- data.frame(kegg_gene_df)
  row_n <- nrow(include_pathways)
...
kegg_pathways <- ggplot(kegg_gene_df,showCategory=path_n)+
