...
#---------------------------------------
 ...
 #--------------------------------------------
  ...
  kegg_all_pathways <- dplyr::arrange(kegg_all_pathways,pvalue)
...
kegg_meta02 <- dplyr::arrange(kegg_meta02,pvalue)
...
kegg_signal02 <- dplyr::arrange(kegg_signal02,pvalue)
...
if(tolower(species)== "human")
    ...
    kegg_up_pathways <- dplyr::arrange(kegg_up_pathways,pvalue)
...
kegg_down_pathways <- dplyr::arrange(kegg_down_pathways,pvalue)
